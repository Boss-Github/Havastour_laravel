...
@section("content")
        ...
        <div class="container py-5">
            <div class="row justify-content-center py-5">
                <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Фергана</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a href="{{ route("index") }}">Главная</a></li>
                            <li class="breadcrumb-item"><a href="{{ route("index") }}">Отели</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Фергана</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    @foreach($information_fergana as $about)
        <!-- About Start -->
