...
@section("content")
        ...
        <div class="container py-5">
            <div class="row justify-content-center py-5">
                <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Самарканд</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a href="{{ route("index") }}">Главная</a></li>
                            <li class="breadcrumb-item"><a href="{{ route("index") }}">Отели</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Самарканд</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    @foreach($information_samarqand as $about)
        <!-- About Start -->
            ...
            <div class="container">
                <div class="row g-5">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        @endif
                        @if($loop->iteration >10 && $loop->iteration <29)
                            <div class="mb-3" style="margin-bottom: 20px;">
                                <small class="fa fa-star fa-1x text-primary"></small>
                                <small class="fa fa-star fa-1x text-primary"></small>
                                <small class="fa fa-star fa-1x text-primary"></small>
                        ...
                        @endif
                        @if($loop->iteration >28 && $loop->iteration <31)
                            <div class="mb-3" style="margin-bottom: 20px;">
                                <small class="fa fa-star fa-1x text-primary"></small>
                                <small class="fa fa-star fa-1x text-primary"></small>
                            </div>
